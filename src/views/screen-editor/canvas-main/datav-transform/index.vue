    ...
    >
      ...
      >
        ...
        <template v-for="(v, k) in points" :key="k">
          <!-- data-html2canvas-ignore：If you wish to exclude certain Elements from getting rendered, 
          you can add a data-html2canvas-ignore attribute to those elements and html2canvas will 
          exclude them from the rendering. -->
          <i
            v-if="v.rotateStyle"
